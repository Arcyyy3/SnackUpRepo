...
@dso_cache = dso_local local_unnamed_addr global [758 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 208720484, ; hash 0xc70d264, from name: libaot-SkiaSharp.Resources
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 623678609, ; hash 0x252c9491, from name: Syncfusion.Maui.ProgressBar
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 878811702, ; hash 0x34619a36, from name: SnackUpClient
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 935262694, ; hash 0x37bef9e6, from name: Syncfusion.Maui.ProgressBar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Syncfusion.Maui.ProgressBar.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	...
	%struct.DSOCacheEntry {
		i64 1071260884, ; hash 0x3fda24d4, from name: SnackUpClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-SnackUpClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 183
	...
	%struct.DSOCacheEntry {
		i64 1665880296, ; hash 0x634b50e8, from name: libaot-Syncfusion.Maui.ProgressBar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Syncfusion.Maui.ProgressBar.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 2048861062, ; hash 0x7a1f2386, from name: aot-SkiaSharp.Resources.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-SkiaSharp.Resources.dll.so
		ptr null; void* handle (0x0)
	}, ; 342
	...
	%struct.DSOCacheEntry {
		i64 2297679138, ; hash 0x88f3cd22, from name: SkiaSharp.Resources
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-SkiaSharp.Resources.dll.so
		ptr null; void* handle (0x0)
	}, ; 386
	...
	%struct.DSOCacheEntry {
		i64 2553287040, ; hash 0x98301180, from name: aot-SnackUpClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-SnackUpClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 439
	...
	%struct.DSOCacheEntry {
		i64 2678801841, ; hash 0x9fab45b1, from name: libaot-SkiaSharp.Resources.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-SkiaSharp.Resources.dll.so
		ptr null; void* handle (0x0)
	}, ; 463
	...
	%struct.DSOCacheEntry {
		i64 2825741313, ; hash 0xa86d6401, from name: libaot-SnackUpClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-SnackUpClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 492
	...
	%struct.DSOCacheEntry {
		i64 3038668484, ; hash 0xb51e66c4, from name: libaot-Syncfusion.Maui.ProgressBar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Syncfusion.Maui.ProgressBar.dll.so
		ptr null; void* handle (0x0)
	}, ; 535
	...
	%struct.DSOCacheEntry {
		i64 3334696868, ; hash 0xc6c36fa4, from name: SkiaSharp.Resources.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-SkiaSharp.Resources.dll.so
		ptr null; void* handle (0x0)
	}, ; 594
	...
	%struct.DSOCacheEntry {
		i64 3491847126, ; hash 0xd0215bd6, from name: aot-SnackUpClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-SnackUpClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 620
	...
	%struct.DSOCacheEntry {
		i64 4004721046, ; hash 0xeeb33196, from name: aot-Syncfusion.Maui.ProgressBar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Syncfusion.Maui.ProgressBar.dll.so
		ptr null; void* handle (0x0)
	}, ; 706
	...
	%struct.DSOCacheEntry {
		i64 4066232736, ; hash 0xf25dc9a0, from name: aot-Syncfusion.Maui.ProgressBar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Syncfusion.Maui.ProgressBar.dll.so
		ptr null; void* handle (0x0)
	}, ; 720
	...
	%struct.DSOCacheEntry {
		i64 4245760099, ; hash 0xfd112863, from name: aot-SkiaSharp.Resources
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-SkiaSharp.Resources.dll.so
		ptr null; void* handle (0x0)
	}, ; 744
	...
	%struct.DSOCacheEntry {
		i64 4278270954, ; hash 0xff013bea, from name: libaot-SnackUpClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-SnackUpClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 752
