...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555205, ; uint32_t android_runtime_jnienv_class_token (0x2000305)
	i32 100671468, ; uint32_t jnienv_initialize_method_token (0x6001fec)
	i32 100671467, ; uint32_t jnienv_registerjninatives_method_token (0x6001feb)
...
@dso_cache = dso_local local_unnamed_addr global [534 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Syncfusion.Licensing.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Syncfusion.Maui.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 30
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Syncfusion.Maui.TabView.dll.so
		ptr null; void* handle (0x0)
	}, ; 43
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.62_name, ; name: libaot-System.Diagnostics.Process.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SnackUpClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 167
	%struct.DSOCacheEntry {
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a850de75-6e56-4aa8-afab-4d1299bf7527\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-SnackUpClient.dll.so\00", align 16
...
@.DSOCacheEntry.21_name = private unnamed_addr constant [35 x i8] c"libaot-Syncfusion.Licensing.dll.so\00", align 16
@.DSOCacheEntry.22_name = private unnamed_addr constant [35 x i8] c"libaot-Syncfusion.Maui.Core.dll.so\00", align 16
@.DSOCacheEntry.23_name = private unnamed_addr constant [38 x i8] c"libaot-Syncfusion.Maui.TabView.dll.so\00", align 16
...
@.DSOCacheEntry.62_name = private unnamed_addr constant [41 x i8] c"libaot-System.Diagnostics.Process.dll.so\00", align 16
